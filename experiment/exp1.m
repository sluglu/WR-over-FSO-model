...
%% Save results
save('results/exp1_PTP_offset_error_vs_asym_delay_STD.mat', 'asym_delay_std', 'off_error_mean', 'elapsed_time');
fprintf('results/Results saved to exp1_PTP_offset_error_vs_asym_delay_STD.mat\n');